...
class IAQTracker:
    def __init__(self, burn_in_cycles = 5, gas_recal_period = 10, ph_slope = 0.03):
	    self.slope = ph_slope
    ...
    def getIAQ(self, bme_data):
        print("gas_ceil ", self.gas_ceil)
        print("gas_cal_data ", self.gas_cal_data)
	...
	#compensate exponential impact of humidity on resistance
	    ...
	    #check if burn-in-cycles are recorded
            ...
            print("gas_ceil {:.1f}".format(self.gas_ceil))
